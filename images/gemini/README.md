...
point is bundled JavaScript. Every image here carries node 22 for the agent's
own skills and plugins, but this is one of the two where the CLI itself needs
it (node 22 from NodeSource, since Ubuntu 24.04 ships node 18 and the package
needs 20 or newer).
